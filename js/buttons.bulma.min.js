...
closeButton:!1},splitDropdown:{tag:"button",text:"&#x25BC;",className:"button is-light",closeButton:!1,align:"split-left",splitAlignClass:"dt-button-split-left"}},buttonCreated:function(a,b){a.buttons&&(a._collection=$('<div class="dropdown-menu"/>').append(a._collection),$(b).append('<span class="icon is-small"><i class="fa fa-angle-down" aria-hidden="true"></i></span>'));return b}});
